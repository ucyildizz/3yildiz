  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-orange-100/50 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
            Üretim <span className="text-gradient-orange">Gruplarımız</span>
          </h2>
          ...
          {categories.map((category, index) => (
            ...
            >
              <Link
                ...
                className="group block relative overflow-hidden rounded-3xl bg-white shadow-sm hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 hover:-translate-y-2"
              >
                {/* Image */}
        ...
        >
          <Link
            href="/urunler"
            className="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 text-white font-semibold rounded-xl hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30 hover:shadow-orange-600/40"
          >
